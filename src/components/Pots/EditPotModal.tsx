...
function EditPotModal() {
  return <div className="fixed inset-0 bg-black/10 z-30 backdrop-blur-xs h-screen flex items-center justify-center">
          <div className="max-w-140 rounded-xl p-8 flex flex-col gap-5 bg-white w-full">
              ...
              <p className="text-preset4 text-grey500">If your saving targets change, feel free to update your pots.</p>
              ...
              <button className="rounded-lg bg-grey900 text-white font-bold text-preset4 h-13 w-full">Save Changes</button>
          </div>
      </div>;
}
